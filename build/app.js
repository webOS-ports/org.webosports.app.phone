...
enyo.path.addPaths({layout: "/home/josh/Documents/Github/org.webosports.app.settings/enyo/../lib/layout/", onyx: "/home/josh/Documents/Github/org.webosports.app.settings/enyo/../lib/onyx/", onyx: "/home/josh/Documents/Github/org.webosports.app.settings/enyo/../lib/onyx/source/"});
...
this.$.TimeDrawer.setOpen(!e.value);
},
...
deviceready: function(e, t) {
this.inherited(arguments);
var n = navigator.service.Request("luna://org.webosports.service.customization", {
...
onDevModeChanged: function(e, t) {
var n = navigator.service.Request("luna://org.webosports.service.customization", {
method: "setDevModeState",
parameters: {
state: t.value ? "enabled" : "disabled"
}
});
},
onGetDevModeStateResponse: function(e) {
this.$.DevModeToggle.setValue(e.status == "enabled");
}
});
